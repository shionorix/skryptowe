...
class Timetable1:
    ...
    def busy(self, term: Term) -> bool:
        ...
        for lesson in self.lesson_list:
            ...
            lesson_end = lesson.term.end_time()
            term_start = (term.hour, term.minute)
            term_end = term.end_time()

            if lesson_end > term_start and lesson_end < term_end:
                return True
            if term_end > lesson_start and term_end < lesson_end:
                return True
            if lesson_start > term_start and lesson_start < term_end:
                return True
            if term_start > lesson_start and term_start < lesson_end:
                return True
